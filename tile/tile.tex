...
\node[entity,below right=1.5\hgap of k] (kc) {}
  edge[arrd] (k);

\node[entity,below left=1.5\hgap of d] (dc) {}
  edge[arr] (d);

\node[entity,above left=1.5\hgap of t] (tc) {}
  edge[arrd] (t);

\node[entity,above right=1.5\hgap of g] (gc) {}
  edge[arr] (g);
